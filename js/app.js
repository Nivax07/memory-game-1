...
/**
 * jQuery stuff to get the star rating system working.
 */
$(document).ready(function() {
	let starsList = $('#stars').find('li');

	starsList.on('mouseover', function() {
		let onStar = parseInt($(this).data('value')); // Star being hovered over
